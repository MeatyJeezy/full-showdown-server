...
const Formats = [
  ...
  {
    name: "[Gen 8] Pixelmon Monotype Cup",
    mod: "gen8",
    //battle: {trunc: Math.trunc},
    // no restrictions, for serious (other than team preview)
    ruleset: [
      "Pixelmon Monotype"
      /*'Standard', '!OHKO Clause', '!Obtainable', 'Min Source Gen = 8', 'Limit One Restricted', 'Terastal Clause', 'Mega Rayquaza Clause', 'Adjust Level = 100', 'Max Level = 100', 'Default Level = 100', 'Same Type Clause'*/
    ],
